...
export default defineConfig({
  // Google OAuth client, PostHog key and Apple Team ID from the repo-root .env (shared with apps/terminal), exposed to main via import.meta.env.
  main: {
    plugins: [externalizeDepsPlugin()],
    resolve: { alias: shared },
    envDir: resolve('../..'),
    envPrefix: ['MYSTICALS_GOOGLE_', 'MYSTICALS_POSTHOG_', 'MYSTICALS_APPLE_']
  },
